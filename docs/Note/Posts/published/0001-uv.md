...
It's extremely easy to switch to uv if you used to use conda and pip. But uv is much more faster than conda. Here is a the way similar to conda and pip to manage the python version and the dependencies via uv.
...
## References: [Link to uv's doc](https://docs.astral.sh/uv/)
